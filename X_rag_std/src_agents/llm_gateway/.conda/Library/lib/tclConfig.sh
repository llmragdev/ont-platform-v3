...
# installed.
TCL_PREFIX='E:/ontology_edu/X_rag_std/src_agents/llm_gateway/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/ontology_edu/X_rag_std/src_agents/llm_gateway/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/ontology_edu/X_rag_std/src_agents/llm_gateway/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/ontology_edu/X_rag_std/src_agents/llm_gateway/.conda\Library\include'
...
TCL_PACKAGE_PATH='E:/ontology_edu/X_rag_std/src_agents/llm_gateway/.conda\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/ontology_edu/X_rag_std/src_agents/llm_gateway/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/ontology_edu/X_rag_std/src_agents/llm_gateway/.conda\Library\lib\tclstub86.lib'
